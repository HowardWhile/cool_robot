...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_COOL_ROBOT_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_COOL_ROBOT_CONTROLLER_HPP_
...
using ControllerStateMsg = cool_robot_controller::CoolRobotController::ControllerStateMsg;
using ControllerReferenceMsg = cool_robot_controller::CoolRobotController::ControllerReferenceMsg;
using ControllerModeSrvType = cool_robot_controller::CoolRobotController::ControllerModeSrvType;
...
class TestableCoolRobotController : public cool_robot_controller::CoolRobotController
{
  FRIEND_TEST(CoolRobotControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(CoolRobotControllerTest, activate_success);
  FRIEND_TEST(CoolRobotControllerTest, reactivate_success);
  FRIEND_TEST(CoolRobotControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(CoolRobotControllerTest, test_update_logic_fast);
  FRIEND_TEST(CoolRobotControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = cool_robot_controller::CoolRobotController::on_configure(previous_state);
...
class CoolRobotControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_cool_robot_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_cool_robot_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_cool_robot_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_cool_robot_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableCoolRobotController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_COOL_ROBOT_CONTROLLER_HPP_
