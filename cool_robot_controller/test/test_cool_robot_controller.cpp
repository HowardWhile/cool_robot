...
#include "test_cool_robot_controller.hpp"
...
using cool_robot_controller::CMD_MY_ITFS;
using cool_robot_controller::control_mode_type;
using cool_robot_controller::STATE_MY_ITFS;

class CoolRobotControllerTest : public CoolRobotControllerFixture<TestableCoolRobotController>
{
};

TEST_F(CoolRobotControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(CoolRobotControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(CoolRobotControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(CoolRobotControllerTest, update_success)
{
  SetUpController();
...
TEST_F(CoolRobotControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(CoolRobotControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(CoolRobotControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(CoolRobotControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(CoolRobotControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(CoolRobotControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(CoolRobotControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
