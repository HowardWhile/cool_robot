...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="cool_robot_bringup",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "controllers_file",
            default_value="cool_robot_controllers.yaml",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_package",
            default_value="cool_robot_description",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="cool_robot.urdf.xacro",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "robot_controller",
            default_value="cool_robot_controller",
            choices=["cool_robot_controller"],
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare(description_package), "rviz", "cool_robot.rviz"]
    )
    ...
    xbox_joystick_node = Node(
        ...
        remappings=[('/servo', '/cool_robot_controller/servo'),
                    ('/trigger_csp', '/cool_robot_controller/trigger_csp'),
                    ('/trigger_cst', '/cool_robot_controller/trigger_cst'),]
